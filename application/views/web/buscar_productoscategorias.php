                ...
                <div class="menu-wrap">
                    <nav class="menu">
                        <div class="icon-list">
                            ...
                            $i++;
                            ?>
                            <a href="<?php echo site_url('web/vercategoria/'.$c['categoria_id']); ?>"><i class="fa fa-fw fa-mobile"></i><!--<img src="<?php //echo site_url('resources/images/categorias/'.$c['categoria_imagen']) ?>" width="26px" height="19px" />--><span><?php echo $c['categoria_nombre']; ?></span></a>
                            <?php
                            }
                            ?>
                        </div>
                                               ...
                                               <div>
                                                    <div id="container">
                                                        ...
                                                        <ul class="list">
                                                            ...
                                                            ?>
                                                            <a href="<?php echo site_url('web/verdetalle/'.$pc['producto_id']) ?>">
                                                                <li>
                                                                    <?php
                                                                    //$mimagen = "";
                                                                    if($pc["producto_foto"]){

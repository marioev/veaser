			...
			<div class="wthreenavigation">
				...
				<nav class="menu">
					<div class="icon-list">
						...
						<a href="<?php echo site_url('resources/kids.'); ?>'); ?>"><i class="fa fa-fw fa-asterisk"></i><span>Kids</span></a>
						...
						<a href="<?php echo site_url('resources/real-estate.'); ?>"><i class="fa fa-fw fa-home"></i><span>Real Estate</span></a>
					</div>
				</nav>
	...
	<!-- Large modal -->
		...
		<div class="container">
			<div class="agile-its-header">
				<div class="logo">
					<h1><a href="<?php echo site_url('resources/index.html'); ?>v"><span>Re</span>sale-v2</a></h1>
				</div>
			...
			<h3>Sign In</h3>
				<form action="#" method="post">
					...
					<div class="forgot-grid">
						...
						<div class="forgot">
							<a href="<?php echo site_url('resources/#'); ?>" data-toggle="modal" data-target="#myModal2">Forgot Password?</a>
						</div>
						<!-- Modal -->
				...
				<h6> Not a Member Yet? <a href="<?php echo site_url('resources/signup.html'); ?>">Sign Up Now</a> </h6>
			</div>
		</div>
	</section>
	<!-- //sign in form -->
					...
					<div class="wthree-foo-grids">
						...
						<div class="col-md-3 wthree-footer-grid">
							...
							<ul>
								...
								<li><a href="<?php echo site_url('resources/icons.html'); ?>2111110.............."><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Icons Page</a></li>
							</ul>
						</div>
						<div class="col-md-3 wthree-footer-grid">

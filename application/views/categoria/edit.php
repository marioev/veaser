				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="estado_id" value="<?php echo ($this->input->post('estado_id') ? $this->input->post('estado_id') : $categoria['estado_id']); ?>" class="form-control" id="estado_id" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="categoria_imagen" value="<?php echo ($this->input->post('categoria_imagen') ? $this->input->post('categoria_imagen') : $categoria['categoria_imagen']); ?>" class="form-control" id="categoria_imagen" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="vistas" class="control-label">Vistas</label>
						<div class="form-group">
							<input type="text" name="vistas" value="<?php echo ($this->input->post('vistas') ? $this->input->post('vistas') : $categoria['vistas']); ?>" class="form-control" id="vistas" />
						</div>
					</div>
				</div>
			</div>

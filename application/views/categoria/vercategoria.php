...
<body>
				...
				<div class="agileits_search">
                                    <form action="#" method="post">
                                        ...
                                        <select id="agileinfo_search" name="agileinfo_search" required="">
                                            ...
                                            ?>
                                            <option <?php echo $es_select; ?> value="<?php echo $categoria['categoria_id'] ?>"><?php echo $categoria['categoria_nombre'] ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="<?php echo site_url('resources/index.html') ?>"><i class="fa fa-home home_1"></i></a> / <span>All Ads</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
	<!-- Products -->
						...
						<select>
                            ...
                            <div class="browse-category ads-list">
                                ...
                                <select class="selectpicker show-tick" data-live-search="true">
                                    ...
                                    ?>
                                    <option <?php echo $es_select; ?> data-tokens="<?php echo $categoria['categoria_id'] ?>"><?php echo $categoria['categoria_nombre'] ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
			...
			<div class="ads-grid">
				...
				<div class="w3ls-featured-ads">
					...
					<div class="w3l-featured-ad">
						<a href="<?php echo site_url('resources/single.html') ?>">
							<div class="w3-featured-ad-left">
								<img src="<?php echo site_url('resources/images/f1.jpg') ?>" title="ad image" alt="" />
							</div>
					...
					<div class="w3l-featured-ad">
						<a href="<?php echo site_url('resources/single.html') ?>">
							<div class="w3-featured-ad-left">
								<img src="<?php echo site_url('resources/images/f2.jpg') ?>" title="ad image" alt="" />
							</div>
							<div class="w3-featured-ad-right">
								<h4>Lorem Ipsum is simply dummy text of the printing industry</h4>
								<p>$ 380</p>
					...
					<div class="w3l-featured-ad">
						<a href="<?php echo site_url('resources/single.html') ?>">
							<div class="w3-featured-ad-left">
								<img src="<?php echo site_url('resources/images/f3.jpg') ?>" title="ad image" alt="" />
							</div>
							<div class="w3-featured-ad-right">
								<h4>Lorem Ipsum is simply dummy text of the printing industry</h4>
								<p>$ 560</p>
					...
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					  <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
						...
						<li role="presentation" class="next">
						  <a href="<?php echo site_url('resources/#profile') ?>" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile">
							<span class="text">Ads with Photos</span>
						  </a>
						</li>
						<li role="presentation">
						  <a href="<?php echo site_url('resources/#samsa') ?>" role="tab" id="samsa-tab" data-toggle="tab" aria-controls="samsa">
					  ...
					  <div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
						   <div>
							...
							<ul class="list">
								<a href="<?php echo site_url('resources/single.html') ?>">
									<li>
									<img src="<?php echo site_url('resources/images/m1.jpg') ?>" title="" alt="" />
								...
								<a href="<?php echo site_url('resources/single.html') ?>">
									<li>
									<img src="<?php echo site_url('resources/images/m2.jpg') ?>" title="" alt="" />
									<section class="list-left">
								...
								<a href="<?php echo site_url('resources/single.html') ?>">
									<li>
									<img src="<?php echo site_url('resources/images/m3.jpg') ?>" title="" alt="" />
									<section class="list-left">
								...
								<a href="<?php echo site_url('resources/single.html') ?>">
									<li>
									<img src="<?php echo site_url('resources/images/m4.jpg') ?>" title="" alt="" />
									<section class="list-left">
								...
								<a href="<?php echo site_url('resources/single.html') ?>">
									<li>
									<img src="<?php echo site_url('resources/images/m5.jpg') ?>" title="" alt="" />
									<section class="list-left">
								...
								<a href="<?php echo site_url('resources/single.html') ?>">
									<li>
									<img src="<?php echo site_url('resources/images/m6.jpg') ?>" title="" alt="" />
									<section class="list-left">
								...
								<a href="<?php echo site_url('resources/single.html') ?>">
									<li>
									<img src="<?php echo site_url('resources/images/m7.jpg') ?>" title="" alt="" />
									<section class="list-left">
								...
								<a href="<?php echo site_url('resources/single.html') ?>">
									<li>
									<img src="<?php echo site_url('resources/images/m8.jpg') ?>" title="" alt="" />
									<section class="list-left">
									<h5 class="title">There are many variations of passages of Lorem Ipsum</h5>
								...
								<a href="<?php echo site_url('resources/single.html') ?>">
									<li>
									<img src="<?php echo site_url('resources/images/m9.jpg') ?>" title="" alt="" />
									<section class="list-left">
								...
								<a href="<?php echo site_url('resources/single.html') ?>">
									<li>
									<img src="<?php echo site_url('resources/images/m10.jpg') ?>" title="" alt="" />
									<section class="list-left">
									<h5 class="title">There are many variations of passages of Lorem Ipsum</h5>
								...
								<a href="<?php echo site_url('resources/single.html') ?>">
									<li>
									<img src="<?php echo site_url('resources/images/m11.jpg') ?>" title="" alt="" />
									<section class="list-left">
								...
								<a href="<?php echo site_url('resources/single.html') ?>">
									<li>
									<img src="<?php echo site_url('resources/images/m12.jpg') ?>" title="" alt="" />
									<section class="list-left">
								...
								<a href="<?php echo site_url('resources/single.html') ?>">
									<li>
									<img src="<?php echo site_url('resources/images/m13.jpg') ?>" title="" alt="" />
									<section class="list-left">
						...
						<ul class="pagination pagination-sm">
							<li><a href="<?php echo site_url('resources/#') ?>">Prev</a></li>
							<li><a href="<?php echo site_url('resources/#') ?>">1</a></li>
							<li><a href="<?php echo site_url('resources/#') ?>">2</a></li>
							<li><a href="<?php echo site_url('resources/#') ?>">3</a></li>
							<li><a href="<?php echo site_url('resources/#') ?>">4</a></li>
							<li><a href="<?php echo site_url('resources/#') ?>">5</a></li>
							<li><a href="<?php echo site_url('resources/#') ?>">6</a></li>
							<li><a href="<?php echo site_url('resources/#') ?>">7</a></li>
							<li><a href="<?php echo site_url('resources/#') ?>">8</a></li>
							<li><a href="<?php echo site_url('resources/#') ?>">Next</a></li>
						</ul>
					  </div>
					</div>
				</div>
